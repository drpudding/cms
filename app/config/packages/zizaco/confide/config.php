...
return array(
    ...
    */
    ...
    |
    | vendor/zizaco/confide/src/views
    |
    ...
    |
    | MAC: not using any of these. see views/site/user for the templates
    |
    */
    'login_form' =>             'confide::login', // not in use
    'signup_form' =>            'confide::signup', // not in use
    'forgot_password_form' =>   'confide::forgot_password', // not in use
    'reset_password_form' =>    'confide::reset_password', // not in use
