...
return array(
	...
	*/
	...
	'providers' => array(
        ...
        'Chumper\Datatable\DatatableServiceProvider', // Chumper Datatable
	...
	*/
	...
	'aliases' => array(
        ...
        'Datatable' 	  => 'Chumper\Datatable\Facades\DatatableFacade', // Chumper Datatable
        ...
        /* CMS Library */
        'Functions'       => 'CMS\Helpers\Functions', // my custom functions
        'String'          => 'CMS\Helpers\String', // String
        //'CustomValidation'=> 'CMS\Validators\CustomValidation', // CustomValidation

	),

	// MAC: array of available languages (see filter('detectLang') )
